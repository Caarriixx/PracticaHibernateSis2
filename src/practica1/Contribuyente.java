...
public class Contribuyente  implements java.io.Serializable {
    ...
    public Contribuyente(int idContribuyente, String nombre, String apellido1, String nifnie, String direccion) {
    ...
    public Contribuyente(int idContribuyente, String nombre, String apellido1, String apellido2, String nifnie, String direccion, String numero, String paisCcc, String ccc, String iban, String email, Double bonificacion, String ayuntamiento, Set vehiculoses, Set reciboses) {
       this.idContribuyente = idContribuyente;
       this.nombre = nombre;
       this.apellido1 = apellido1;
